...
for GraalVM/native-image. Until now I have not found a solution for this and thus cannot
read or write any XML files which limits the usability of the software quite a bit.
