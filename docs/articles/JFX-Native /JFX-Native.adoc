...
The performance of the community editon of `native-image` sometimes seems to have
a much worse performance than a standard VM due to some missing code optimizations.
